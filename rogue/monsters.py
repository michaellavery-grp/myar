...
MONSTERS = [
    MonsterType("giant rat", "r", 1, "1d6", 11, "1d3", 2, 1, 6, _f()),
    MonsterType("bat", "b", 1, "1d8", 13, "1d2", 3, 1, 8, _f("erratic")),
    MonsterType("kobold", "k", 1, "1d8", 12, "1d4", 4, 1, 7, _f("humanoid")),
    MonsterType("jackal", "j", 1, "1d4", 12, "1d2", 2, 1, 6, _f("pack")),
    MonsterType("snake", "s", 2, "2d6", 13, "1d3", 9, 2, 11, _f("poison")),
    MonsterType("goblin", "g", 2, "2d8", 13, "1d6", 12, 2, 12, _f("humanoid")),
    ...
    MonsterType("lich", "L", 11, "10d8", 18, "2d10", 380, 22, 70,
                _f("undead")),
    MonsterType("fire drake", "d", 11, "10d10", 18, "3d8", 420, 25, 75, _f()),
